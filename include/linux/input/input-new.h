...
#define SET_BOOSTER  { \
	...
	set_qos(&_this->cpu_qos, /*PM_QOS_CPU_FREQ_MIN*/PM_QOS_CPU_FREQ_MIN, _this->param[_this->index].cpu_freq);  \
	set_qos(&_this->kfc_qos, /*PM_QOS_KFC_FREQ_MIN*/PM_QOS_KFC_FREQ_MIN, _this->param[_this->index].kfc_freq);  \
