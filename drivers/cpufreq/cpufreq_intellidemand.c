...
#define DEF_STEP_UP_EARLY_HISPEED		(1600000)
#define DEF_STEP_UP_INTERIM_HISPEED		(1900000)
...
#define SUP_SLOW_UP_FREQUENCY			(1300000)
#define SUP_HIGH_SLOW_UP_FREQUENCY		(1900000)
